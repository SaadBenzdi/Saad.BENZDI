            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            <div className="w-12 h-12 bg-[#9FE870] rounded-full flex items-center justify-center text-2xl font-bold text-black">
                                S
                            </div>
                            <span className="text-2xl font-bold text-white">Saad.</span>
                        </div>
                ...
                >
                    <p className="text-gray-400">
                        Copyright © 2024 <span className="text-[#9FE870]">Saad</span>. All Rights Reserved.
                    </p>
